...
# В связи с обновлением 7.1 счетчик перестал работать
Механизм работы счетчика с обновы 7.1 теперь не работает.  В будущем неизвестно получится ли сделать фикс.
