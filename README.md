...
# **Отличие local db от Common**
Эти версии обе одинаково работают. Common  версия сохраняет данные в папке с КРМП, если запустить проверку файлов, то эти данные удалятся, а local DB сохраняет данные в AppData, тем самым данные никак не удалятся, их их можно редактировать.

# **Обязательно!!!**
При первом открытии игры с скриптом (local DB) необходимо предоставить нужные разрешения:
